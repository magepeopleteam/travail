 ...
 *
 * One case always overrides the Customizer setting below: a page
 * generated by the Elementor homepage builder (Travail → Homepages, see
 * inc/importer/class-travail-elementor-page-builder.php), once it's
 * assigned as the front page, is a real, fully-editable Elementor page —
 * front-page.php should render its own the_content() instead of either
 * hook-based homepage variation, regardless of this legacy setting.
 *
 * @return bool
 */
